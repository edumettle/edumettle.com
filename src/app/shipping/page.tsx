          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            <div className="space-y-8">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                <h2 className="text-2xl font-bold text-blue-800 mb-4">Digital Delivery Only</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Address Collection Purpose</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Course Access Timeline</h2>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Course materials available instantly after payment</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-6 h-6 bg-primary-600 text-white rounded-full flex items-center justify-center text-sm font-bold">2</div>
                      <div>
                        <h4 className="font-semibold text-gray-900">Live Session Links</h4>
                        <p className="text-gray-600 text-sm">Session links sent 24 hours before each class</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-6 h-6 bg-primary-600 text-white rounded-full flex items-center justify-center text-sm font-bold">3</div>
                      <div>
                        <h4 className="font-semibold text-gray-900">Digital Certificate</h4>
                        <p className="text-gray-600 text-sm">Certificate delivered via email upon completion</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Future Physical Items</h2>
                <p className="text-gray-600 leading-relaxed">
