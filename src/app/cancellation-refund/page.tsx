        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <div className="space-y-8">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Failed Payment Refunds</h2>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Course Access</h2>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Course Completion</h2>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Contact for Payment Issues</h2>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                <h2 className="text-2xl font-bold text-yellow-800 mb-4">Before You Purchase</h2>
